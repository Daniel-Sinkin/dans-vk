...
Third-party code is committed directly under 'vendor/' so downstream projects
...
- SDL: 'https://github.com/libsdl-org/SDL'
  ...
  - Re-vendored from a fresh checkout of the pinned commit. Every kept file is
    byte-for-byte upstream; no SDL source was edited, so the only differences
    from upstream are the deletions listed above.
